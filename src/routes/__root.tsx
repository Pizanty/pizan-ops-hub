...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Tovanto" },
      { property: "og:title", content: "Tovanto" },
      { name: "twitter:title", content: "Tovanto" },
      { name: "description", content: "Tovanto — מערכת ההפעלה לקייטרינג ואירועים, מבית PizanTech" },
      { property: "og:description", content: "Tovanto — מערכת ההפעלה לקייטרינג ואירועים, מבית PizanTech" },
      { name: "twitter:description", content: "Tovanto — מערכת ההפעלה לקייטרינג ואירועים, מבית PizanTech" },
